...
extras=""
size=1000 # Size of image in megabytes
...
#make headers_install ARCH=arm INSTALL_HDR_PATH=${basedir}/root/usr/include
...
cd ${basedir}
#Compat drivers
wget https://www.kernel.org/pub/linux/kernel/projects/backports/2014/05/01/backports-20140501.tar.gz -O backports.tar.gz
tar -xvzf backports.tar.gz
cd backports
wget http://patches.aircrack-ng.org/mac80211.compat08082009.wl_frag+ack_v1.patch -O mac80211.compat08082009.wl_frag+ack_v1.patch
